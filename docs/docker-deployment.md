...
$env:MODE="docker"; iwr https://raw.githubusercontent.com/Yan-ShiBo/BiliClaw-Extended/main/scripts/install.ps1 -UseBasicParsing | iex
```
...
> ```
> 请按照 https://raw.githubusercontent.com/Yan-ShiBo/BiliClaw-Extended/main/docs/docker-deployment.md 的说明帮我用 Docker Compose 部署 OpenBiliClaw 后端（务必用 Bash 的 curl 下载这个文档，不要用 WebFetch）
> ```
