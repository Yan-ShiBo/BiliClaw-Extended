...
`openbiliclaw init` 的首轮信号现在由本轮勾选的数据来源合流。v0.3.118+ 起 B 站与小红书 / 抖音 / YouTube / X / 知乎一样是可选来源：默认勾选、可取消，CLI / 插件 / 桌面 Web / `/setup/` 至少保留一个来源；所有所选来源都没有拉到信号时以 `empty_signals` 失败，不再生成空画像。
